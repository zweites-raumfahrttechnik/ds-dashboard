...
export const Userlist_Account = `${v1}/userlist`;
export const REDIS_OP_URL = `${v1}/redisOp`;
export const REDIS_OP_CUSTOM_URL=`${v1}/redisOpCustomForm`;

export const redisMetaTotal_URL=`${v1}/dbtotalNum`;
export const REDIS_META_SIZE_URL=`${v1}/dbsize`;
export const REDIS_KEYS_URL=`${v1}/redisKeys`;
